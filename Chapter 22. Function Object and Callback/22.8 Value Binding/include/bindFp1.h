...
inline Binder<FunctionPtr<RT, P1>,
              PNum,
              BoundVal<typename FunctorParam<FunctionPtr<RT, P1>, PNum>::Type>>
bindfp(RT (*fp)(P1),
       typename ForwardParamT<typename FunctorParam<FunctionPtr<RT, P1>,
                                                    PNum
                                                    >::Type>::Type val)
{
    return Binder<FunctionPtr<RT, P1>,
                  PNum,
                  BoundVal<typename FunctorParam<FunctionPtr<RT, P1>,
                                                 PNum>::Type>>(func_ptr(fp),
                                                               BoundVal<typename FunctorParam<FunctionPtr<RT, P1>, PNum>::Type>(val));
}
